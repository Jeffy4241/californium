...
public class SimpleFileServer extends AbstractTestServer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// create server
			SimpleFileServer server = new SimpleFileServer(config, coapRootPath, filesRoot);
	 ...
	 */
	public SimpleFileServer(NetworkConfig config, String coapRootPath, File filesRoot) throws SocketException {
		super(config);
