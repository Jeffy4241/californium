...
public final class PskPublicInformation extends Bytes {
	 ...
	 * 
	 * Overwrite the decoded string with the intended string.
	 * 
	 * @param publicInfo PSK public information as string. Identity or hint.
	 * @throws NullPointerException if public information is {@code null}
	...
	/**
	 * Check, if public information encoded as bytes starts with the provided
	 * prefix.
	 * 
	 * @param prefix prefix to check
	 * @return {@code true} if the encoded bytes start with the prefix.
	 */
	public boolean startsWith(String prefix) {
		...
		byte[] bytes = getBytes();
		byte[] startBytes = prefix.getBytes(UTF_8);
