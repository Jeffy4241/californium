...
public class PskPublicInformationTest {
	...
	@Test
	public void testPublicInformationStartsWith() {
		PskPublicInformation information = new PskPublicInformation("test1");
		assertTrue(information.startsWith("test"));
		assertTrue(information.startsWith("test1"));
		assertFalse(information.startsWith("test12"));
		assertFalse(information.startsWith("Test"));
	}
